 ...
 * Step 1: choose a tier. Step 2: name the org. Then creates org + admin profile.
 */
...
export default function Onboarding() {
  ...
  const [step,    setStep]    = useState(1)   // 1 = tier, 2 = org name
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6" style={{ background: '#fbfaf8' }}>
      <div className="w-full" style={{ maxWidth: step === 1 ? 820 : 440 }}>
            ...
            {TIERS.map(t => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs mb-4" style={{ color: '#9ca3af' }}>{t.sub}</p>
