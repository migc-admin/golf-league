    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6" style={{ background: '#fbfaf8' }}>
      <div className="w-full max-w-sm">
        ...
        <div style={{
          ...
          {mode === 'reset' && (
            <div className="mb-5">
              <h2 className="text-base font-bold text-ink mb-1">Reset your password</h2>
              <p className="text-xs text-ink-muted">Enter your email and we'll send you a reset link.</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {mode === 'reset' && (
              <button
                ...
                className="w-full text-center text-xs text-ink-muted underline hover:text-ink"
              >
                Back to sign in
              </button>
            )}
